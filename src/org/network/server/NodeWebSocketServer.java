...
//					graphBuilder.buildGraph("updateParameters", jsonMessage.getString("parameters"), sessionHandler, jsonMessage.getString("speed"));
					ChargeUpdater.setParameters(jsonMessage.getString("parameters"));
					break;
				case "remove":
					break;
